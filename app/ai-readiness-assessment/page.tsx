        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {STATS.map((s, i) => (
            <FadeUp key={i} delay={i * 75}>
              <div>
                <p className="text-4xl md:text-5xl font-extrabold text-[#111111] tracking-tight leading-none">
                  {s.value}
                </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          <FadeUp className="lg:col-span-5">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight">
              {WHY.headlineLead}{' '}
              <span className="text-[#CA3C27]">{WHY.headlineAccent}</span>
            </h2>
          </FadeUp>
        ...
        <FadeUp>
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight">
              ...
              <span className="text-[#CA3C27]">{BENEFITS_HEADING.headlineAccent}</span>
            </h2>
          </div>
        </FadeUp>
          ...
          {BENEFITS.map((b) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-[#CA3C27]/10 flex items-center justify-center mb-5 flex-shrink-0">
                <DynamicIcon slug={b.slug} size={24} className="text-[#CA3C27]" />
              </div>
              <h3 className="text-base font-semibold text-[#111111] leading-snug mb-2">
                {b.title}
              </h3>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28 lg:py-32">
        <FadeUp>
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight">
              ...
              <span className="text-[#CA3C27]">{FRAMEWORK_HEADING.headlineAccent}</span>
            </h2>
          </div>
        </FadeUp>
        ...
        <StaggerChildren stagger={100} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {FRAMEWORK.map((step) => (
            <div
              key={step.number}
              className="relative bg-[#111111] text-white rounded-2xl p-7 flex flex-col h-full"
            >
              <span className="text-5xl font-extrabold text-[#CA3C27] tracking-tight leading-none mb-5">
                {step.number}
              </span>
        ...
        <FadeUp>
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight">
              ...
              <span className="text-[#CA3C27]">{INDUSTRIES_HEADING.headlineAccent}</span>
            </h2>
          </div>
        </FadeUp>
          ...
          {INDUSTRIES.map((i) => (
            ...
            >
              ...
              <div className="flex-1">
                <h3 className="text-base font-semibold text-[#111111] leading-snug mb-1">
                  {i.title}
                </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <FadeUp delay={100} className="lg:col-span-7 order-2">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight mb-6">
              ...
              <span className="text-[#CA3C27]">{WHY_ITSCO.headlineAccent}</span>
            </h2>
            {WHY_ITSCO.paragraphs.map((p, i) => (
              <p
                key={i}
                className="text-base md:text-lg text-[#404040] leading-relaxed mb-6"
              >
                {p}
              </p>
            ))}
              ...
              {WHY_ITSCO.bullets.map((b, i) => (
                <li key={i} className="flex gap-3 items-start">
                  <span
                    ...
                    aria-hidden
                  />
                  <span className="text-base text-[#404040] leading-relaxed">{b}</span>
                </li>
              ))}
            </ul>
          </FadeUp>
