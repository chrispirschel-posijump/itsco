          ...
          <div>
            ...
            <ul className="space-y-4 text-base text-itsco-body leading-relaxed">
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-itsco-red mt-2.5 flex-shrink-0" />
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-itsco-dark via-itsco-dark/70 to-itsco-dark/40" />
