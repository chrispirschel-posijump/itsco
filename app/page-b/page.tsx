...
const STATS = [
  { number: '22+',   label: 'Years serving healthcare' },
  { number: '14',    label: 'EmergeOrtho locations' },
  { number: '< 1hr', label: 'Critical response time' },
  { number: '0',     label: 'Client breaches' },
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight mb-6">
              Healthcare IT is high-stakes. Most providers miss that.
            </h2>
            <ul className="space-y-4 text-base text-[#404040] leading-relaxed">
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#CA3C27] mt-2.5 flex-shrink-0" />
                HIPAA compliance gaps that create audit risk and patient data exposure
              </li>
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#CA3C27] mt-2.5 flex-shrink-0" />
                Legacy EHR systems that slow down clinical workflows and frustrate staff
              </li>
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#CA3C27] mt-2.5 flex-shrink-0" />
                Disconnected locations with inconsistent security posture and no unified monitoring
              </li>
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#CA3C27] mt-2.5 flex-shrink-0" />
                IT vendors who don't understand healthcare operations or regulatory demands
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-base text-[#404040] leading-relaxed">
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#111111] mt-2.5 flex-shrink-0" />
                HIPAA-compliant infrastructure built by engineers who've served healthcare for 25+ years
              </li>
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#111111] mt-2.5 flex-shrink-0" />
                Unified monitoring across all locations, from a single-office practice to a 14-site system
              </li>
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#111111] mt-2.5 flex-shrink-0" />
                Cybersecurity programs built around patient data protection and regulatory preparedness
              </li>
              <li className="flex gap-3">
                <span className="w-1.5 h-1.5 rounded-full bg-[#111111] mt-2.5 flex-shrink-0" />
                A team that speaks your language: EHR, HL7, HIPAA, and clinical workflow fluency
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 lg:items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight mb-8">
              Outcomes that matter to healthcare leaders.
            </h2>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28 lg:py-32">
        <div className="max-w-2xl mb-14">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight">
            Services built for regulated industries.
          </h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          <ServiceCard
            ...
            description="24/7 SOC monitoring, MDR, and compliance programs built for healthcare environments."
            href="/cybersecurity/"
          />
          <ServiceCard
            slug="managed-it-services"
            title="Managed IT Services"
            description="Proactive monitoring, helpdesk, and network management without the overhead of an in-house team."
            href="/managed-it-services/"
          />
          <ServiceCard
            slug="backup-disaster-recovery"
            title="Backup & Disaster Recovery"
            description="HIPAA-compliant backup solutions with tested recovery plans protecting patient data."
...
export default function PageB() {
  return (
    <>
      ...
      {/* 1. Hero — full-bleed background image with stats */}
      ...
      {/* 3. Capabilities with supporting image */}
      <CapabilitiesSection />
