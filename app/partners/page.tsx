      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28 lg:py-32">
        <FadeUp>
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-itsco-dark leading-[1.15] tracking-tight">
              ...
              <span className="text-itsco-red">{CATEGORIES_HEADING.headlineAccent}</span>
            </h2>
          </div>
        </FadeUp>
        ...
        <StaggerChildren stagger={75} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {CATEGORIES.map((c) => (
            ...
            >
              <h3 className="text-xl font-bold text-itsco-dark leading-snug mb-3 tracking-tight">
                {c.title}
              </h3>
              <p className="text-base text-itsco-body leading-relaxed mb-5">{c.description}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <FadeUp delay={100} className="lg:col-span-8 order-2">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-itsco-dark leading-[1.15] tracking-tight mb-6">
              ...
              <span className="text-itsco-red">{ACCREDITATION.headlineAccent}</span>
            </h2>
