      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28 lg:py-32">
        <FadeUp>
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-itsco-dark leading-[1.15] tracking-tight">
              Real results from <span className="text-itsco-red">financial-sector clients.</span>
            </h2>
          </div>
        </FadeUp>
        ...
        <StaggerChildren stagger={120} className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {[
            ...
            <CaseStudyCard
              ...
              description="A modernized computing infrastructure and SOC 2 Type 2 program helped Southern Rehabilitation Network qualify for state contracts and reduce risk."
              stat="SOC 2 Type 2"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28 lg:py-32">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          <ServiceCard
            ...
            description="24/7 SOC, MDR, firewall management, and compliance programs scaled to the threats financial institutions face every day."
            href="/cybersecurity/"
          ...
          <ServiceCard
            ...
            description="Continuous FFIEC, GLBA, SOX, and PCI posture management — between audits, not just before them."
          ...
          <ServiceCard
            ...
            description="Strategic IT, security, and AI leadership for institutions that need executive expertise without a full-time hire."
...
export default function FinancialServicesITPage() {
  return (
    <>
      <script
      ...
      <FAQSection />
      <RelatedServices />
      <BookingCTA utmSuffix="financial-services-it-bottom" />
      <Footer />
    </>
  )
}
