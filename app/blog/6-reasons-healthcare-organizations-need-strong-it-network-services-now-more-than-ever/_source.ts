...
// Target keywords: "healthcare IT network services", "healthcare network IT".

export const PAGE_TITLE =
  '6 Reasons Healthcare Organizations Need Strong IT Network Services Now More Than Ever | ITSco'
...
export const ARTICLE = [
  ...
  { type: 'h2', text: 'The Risks of Underinvesting' },
  {
    type: 'p',
    text: 'Healthcare organizations that underinvest in network services typically experience:',
  },
  {
    type: 'ul',
    items: [
