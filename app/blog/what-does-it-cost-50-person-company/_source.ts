...
export const ARTICLE: readonly BlogBlock[] = [
  ...
  },
  {
    ...
    items: [
      ...
      '**Productivity drag.** Slow machines, recurring glitches, and "have you tried restarting" cycles typically cost each employee 8–15 hours a year. At a $75/hour loaded cost, that\'s $600–$1,100 per employee — $30K–$55K across a 50-person team, often more than the entire helpdesk line.',
