        ...
        <FadeUp>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight mb-6">
              Technology without strategy is <span className="text-[#CA3C27]">just cost.</span>
            </h2>
          ...
          <FadeUp>
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight mb-10">
                From assessment to roadmap in <span className="text-[#CA3C27]">four steps.</span>
              </h2>
  ...
  return (
    <section className="bg-white border-t border-[#EBEBEB]">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28">
        <FadeUp>
          <div className="bg-[#FAFAFA] border border-[#EBEBEB] rounded-2xl p-10 md:p-14 max-w-4xl mx-auto shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28 lg:py-32">
        <FadeUp>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight mb-6">
              Led by people who've <span className="text-[#CA3C27]">done this before.</span>
            </h2>
            <p className="text-base md:text-lg text-[#404040] leading-relaxed mb-4">
      ...
      <section className="relative bg-white min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 lg:px-12 py-32 pt-44">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <FadeUp delay={100}>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-[#111111] leading-[1.05] tracking-tight mb-6 max-w-[16ch] mx-auto">
            ...
            <FadeUp delay={200}>
              <p className="text-lg md:text-xl text-[#404040] leading-relaxed max-w-[42ch] mx-auto mt-6">
            ...
            <FadeUp delay={400}>
              <div className="mt-12 inline-block border border-[#EBEBEB] bg-white rounded-2xl px-10 py-8 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
                <CountUp
                  value={25}
                  suffix="+"
                  className="text-5xl md:text-6xl font-extrabold text-[#111111] leading-none tracking-tight block"
                />
