...
// ── 1. Hero — full-bleed split with animated stats ──────────────────────────
    ...
    <section className="relative bg-itsco-dark min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="relative flex-1 flex items-center w-full max-w-7xl mx-auto px-6 lg:px-12 py-36">
        <div className="lg:max-w-[50%]">
          ...
          <FadeUp delay={100}>
            <h1 className="text-6xl md:text-7xl lg:text-[4.5rem] font-extrabold text-white leading-[1.0] tracking-tight mb-8">
              Turn IT Into Your Growth Engine.
            </h1>
          </FadeUp>
          <FadeUp delay={200}>
            <p className="text-lg text-white/60 leading-relaxed max-w-[38ch] mb-10">
      ...
      {/* Stats — anchored to bottom of hero, with count-up */}
            ...
            {STATS.map((s) => (
              <div key={s.label} className="flex items-center gap-4 px-6 md:px-8 py-6 first:pl-0">
                <CountUp
                  ...
                  prefix={s.prefix}
                  suffix={s.suffix}
                  className="text-2xl md:text-3xl font-extrabold text-white leading-none tracking-tight whitespace-nowrap"
                />
...
// ── Services — horizontal list rows with stagger ────────────────────────────
  ...
  return (
    <section className="bg-[radial-gradient(ellipse_at_top,_#1a1a1a_0%,_#111111_70%)]">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 md:py-28 lg:py-32">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16 pb-16 border-b border-white/10">
            <div className="max-w-xl">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white leading-[1.15] tracking-tight">
                Your full IT program, under one roof.
              </h2>
            </div>
            <p className="text-sm text-white/45 leading-relaxed max-w-[36ch] md:text-right">
        ...
        <StaggerChildren stagger={60} className="divide-y divide-white/[0.07]">
          {SERVICES.map((s) => (
            <Link
              key={s.number}
              href={s.href}
            ...
            >
              ...
              <p className="text-sm text-white/55 leading-relaxed lg:flex-1 lg:px-10 group-hover:text-white/80 transition-[color] duration-200">
                {s.description}
              </p>
              <ArrowRight
                size={16}
