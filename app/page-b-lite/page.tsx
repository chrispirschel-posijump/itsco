          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight mb-6">
                Healthcare IT is high-stakes. <span className="text-[#CA3C27]">Most providers miss that.</span>
              </h2>
              <ul className="space-y-4 text-base text-[#404040] leading-relaxed">
                <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#CA3C27] mt-2.5 flex-shrink-0" />HIPAA compliance gaps that create audit risk and patient data exposure</li>
                <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#CA3C27] mt-2.5 flex-shrink-0" />Legacy EHR systems that slow down clinical workflows and frustrate staff</li>
                <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#CA3C27] mt-2.5 flex-shrink-0" />Disconnected locations with inconsistent security posture and no unified monitoring</li>
                <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#CA3C27] mt-2.5 flex-shrink-0" />IT vendors who don't understand healthcare operations or regulatory demands</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-base text-[#404040] leading-relaxed">
                <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#111111] mt-2.5 flex-shrink-0" />HIPAA-compliant infrastructure built by engineers who've served healthcare for 25+ years</li>
                <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#111111] mt-2.5 flex-shrink-0" />Unified monitoring across all locations, from a single-office practice to a 14-site system</li>
                <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#111111] mt-2.5 flex-shrink-0" />Cybersecurity programs built around patient data protection and regulatory preparedness</li>
                <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-[#111111] mt-2.5 flex-shrink-0" />A team that speaks your language: EHR, HL7, HIPAA, and clinical workflow fluency</li>
              </ul>
            </div>
          </div>
        </FadeUp>
          ...
          <FadeUp>
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight mb-8">
                Outcomes that matter to <span className="text-[#CA3C27]">healthcare leaders.</span>
              </h2>
        ...
        <FadeUp>
          <div className="max-w-2xl mb-14">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#111111] leading-[1.15] tracking-tight">
              Services built for <span className="text-[#CA3C27]">regulated industries.</span>
            </h2>
          </div>
        </FadeUp>
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden bg-white">
        ...
        <div className="relative flex-1 flex items-center w-full max-w-7xl mx-auto px-6 lg:px-12 py-36 pt-48">
          <div className="max-w-2xl">
            <FadeUp>
              <p className="text-xs font-bold uppercase tracking-[0.15em] text-[#CA3C27] mb-4">Healthcare IT Services</p>
            </FadeUp>
            <FadeUp delay={100}>
            ...
            <FadeUp delay={200}>
              <p className="text-lg md:text-xl text-[#404040] leading-relaxed max-w-[42ch] mb-10">
