                ...
                {visibleItems.map((item, pi) => {
                  ...
                  if (isList(item)) {
                    return (
                      <ul
                        key={pi}
                        className={`list-disc pl-5 text-base text-itsco-body leading-relaxed space-y-1.5 ${spacing}`}
                      >
                  ...
                  return (
                    <p
                      key={pi}
                      className={`text-base text-itsco-body leading-relaxed ${spacing}`}
                    >
                      {item}
...
export default function TransportationLogisticsITPage() {
  return (
    <>
      {faqJsonLd && (
        <script
      ...
      <FAQSection />
      <RelatedServices />
      <BookingCTA utmSuffix="transportation-logistics-it-bottom" />
      <Footer />
    </>
  )
}
