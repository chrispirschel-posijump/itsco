...
// Backgrounds for the 4 pillar sections (alternates softly between paper + blush)
...
export default function RealEstateITPage() {
  return (
    <>
      <script
      ...
      <FAQSection />
      <RelatedServices />
      <BookingCTA utmSuffix="real-estate-it-bottom" />
      <Footer />
    </>
  )
}
